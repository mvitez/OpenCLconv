...
"__kernel void conv9x9(int w, __global const half4 *in, __constant half *ck, __global half4 *out)\n"
"{\n"
"	int i, x, y, y1, i9;\n"
"	half4 sum;\n"
"\n"
...
#define NQUEUES 1
	...
	out = (cl_short4 *) calloc((dsize-8)*(dsize-8), sizeof(*out));
	ck = (cl_short *) calloc(9*9, sizeof(*ck));
	in[0].x = 0x3c00;
	in[1].x = 0x4000;
	in[dsize].x = 0x4100;
	ck[0] = 0x3c00;
