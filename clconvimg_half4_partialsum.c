...
"		i9 = 9*i;\n"
"		y1 = y+i;\n"
"		sum[0] += read_imageh(in, sampler, (int2)(x, y1)) * ck[i9];\n"
"		sum[1] += read_imageh(in, sampler, (int2)(x+1 ,y1)) * ck[i9+1];\n"
"		sum[2] += read_imageh(in, sampler, (int2)(x+2 ,y1)) * ck[i9+2];\n"
"		sum[3] += read_imageh(in, sampler, (int2)(x+3 ,y1)) * ck[i9+3];\n"
"		sum[4] += read_imageh(in, sampler, (int2)(x+4 ,y1)) * ck[i9+4];\n"
"		sum[5] += read_imageh(in, sampler, (int2)(x+5 ,y1)) * ck[i9+5];\n"
"		sum[6] += read_imageh(in, sampler, (int2)(x+6 ,y1)) * ck[i9+6];\n"
"		sum[7] += read_imageh(in, sampler, (int2)(x+7 ,y1)) * ck[i9+7];\n"
"		sum[8] += read_imageh(in, sampler, (int2)(x+8 ,y1)) * ck[i9+8];\n"
"	}\n"
"	osum = sum[0] + sum[1] + sum[2] + sum[3] + sum[4] + sum[5] + sum[6] + sum[7] + sum[8];\n"
"	write_imageh(out, (int2)(x,y), osum);\n"
"}\n";
